...
export default function Home() {
    return (
        <div className="flex flex-col">
            ...
            <section id="skills" className="flex flex-col items-center justify-center gap-4 sm:py-32 py-16">
                ...
                <div className="flex flex-row gap-4 flex-wrap justify-center items-center">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">JavaScript</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">TypeScript</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">Python</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">NextJS</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">Angular</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">NestJS</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">Spring Boot</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">Django</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <p className="leading-7">PostgreSQL</p>
                    </div>
            ...
            <Separator />
            {/* Contact */}
            <section id="contact" className="flex flex-col items-center justify-center gap-4 sm:py-32 py-16">
                <h2 className="scroll-m-20 text-3xl font-extrabold tracking-tight lg:text-4xl">
                    Get In Touch
                </h2>
                <p className="leading-7">
